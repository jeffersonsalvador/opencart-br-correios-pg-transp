...
class ControllerExtensionPaymentPagseguro extends Controller {
 	public function index() {
		...
		$this->load->model('localisation/zone');
	   	...
	   	if ($this->cart->hasShipping()) {
			...
			if($this->config->get('pagseguro_campo_numero') != "" && isset($order_info['shipping_' . $this->config->get('pagseguro_campo_numero')]) && $order_info['shipping_' . $this->config->get('pagseguro_campo_numero')] != ''){
				...
				$numero = $this->model_extension_payment_pagseguro->getFieldValue($this->config->get('pagseguro_campo_numero'));
			...
			if($this->config->get('pagseguro_campo_complemento') != "" && isset($order_info['shipping_' . $this->config->get('pagseguro_campo_complemento')]) && $order_info['shipping_' . $this->config->get('pagseguro_campo_complemento')] != ''){
				...
				$complemento = $this->model_extension_payment_pagseguro->getFieldValue($this->config->get('pagseguro_campo_complemento'));
		...
		$paymentRequest->setNotificationURL($this->url->link('extension/payment/pagseguro/callback')); 
